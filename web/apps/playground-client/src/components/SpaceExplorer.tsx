...
const SpaceExplorer: React.FC = () => {
  ...
  return (
    <div className="p-2 space-y-1">
      ...
      <Dialog
        open={!!deletingSpaceId}
        onOpenChange={() => setDeletingSpaceId(null)}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Are you sure?</DialogTitle>
            <DialogDescription>
              This will permanently delete the space "{deletingSpaceId}" and all
              pods within it. This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" onClick={() => setDeletingSpaceId(null)}>
              Cancel
            </Button>
            <Button
              variant="destructive"
