...
const RARITY_MAP: RarityType[] = ["NORM", "RARE", "EPIC", "LGND", "MYTH", "MYTH", "GOD", "GOD", "????", "ART", "JUNK"];
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-6 p-4 sm:p-6 max-w-fit">
            ...
            {Array.from({ length: Math.max(0, 6 - frogs.length) }).map((_, index) => (
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-4 right-4 flex items-center justify-center">
        <div 
          className="w-16 h-16 bg-blue-100 rounded flex items-center justify-center"
        >
          <div 
