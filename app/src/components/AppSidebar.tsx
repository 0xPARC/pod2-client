...
import { CodeIcon, FileCheck2Icon, FileIcon, FilePenLineIcon, InboxIcon, MessageSquareIcon, SettingsIcon } from "lucide-react"
...
export function AppSidebar() {
  const { appState, initialize, currentView, selectedFilter, setCurrentView, setSelectedFilter, setExternalPodRequest } = useAppStore();
            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton 
                  ...
                  isActive={currentView === 'pods' && selectedFilter === 'signed'}
                >
                  <FilePenLineIcon /> 
                  Signed
                </SidebarMenuButton>
          ...
          <DropdownMenuContent align="start" className="w-64">
            ...
            {privateKeys.length > 0 && (
              <DropdownMenuItem disabled>
                Keys: {privateKeys.length} ({privateKeys.filter(k => k.is_default).length} default)
              </DropdownMenuItem>
            )}
            {nodeId && (
              ...
              <>
                <div className="p-2 space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSendPodForm(prev => ({ ...prev, peerNodeId: e.target.value }))}
                  />
                  ...
                  {sendMode === 'pod' && (
                    <Input
                      ...
                      onChange={(e) => setSendPodForm(prev => ({ ...prev, podId: e.target.value }))}
                    />
                  )}
                  ...
                  {sendMode === 'message' && (
                    <Input
                      ...
                      onChange={(e) => setSendPodForm(prev => ({ ...prev, messageText: e.target.value }))}
                    />
                  )}
                  ...
                  <Input
                    ...
                    onChange={(e) => setSendPodForm(prev => ({ ...prev, senderAlias: e.target.value }))}
                  />
                  ...
                  {sendMode === 'message' && privateKeys.filter(k => k.is_default).length === 0 && (
