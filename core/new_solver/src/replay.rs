    ...
    match head.predicate() {
        ...
        Predicate::Native(np) => {
            ...
            match np {
                ...
                None | False | ContainerDelete | DictContains | DictNotContains | SetContains
                | SetNotContains | ArrayContains | GtEq | Gt | DictInsert | DictUpdate
                | DictDelete | SetInsert | SetDelete | ArrayUpdate => Ok(std::option::Option::None),
            }
        }
        _ => Ok(None),
    }
